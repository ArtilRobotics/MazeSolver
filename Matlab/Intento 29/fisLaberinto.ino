...
void setup()
{
    ...
    // Pin mode for Input: Diagonal_Derecho
    pinMode(0 , INPUT);
    // Pin mode for Input: Diagonal_Izquierdo
    pinMode(1 , INPUT);
    // Pin mode for Input: Lateral_Derecho
    pinMode(2 , INPUT);
    // Pin mode for Input: Lateral_Izquierdo
    pinMode(3 , INPUT);


    // initialize the Analog pins for output.
    // Pin mode for Output: Velocidad_Derecha
    pinMode(4 , OUTPUT);
    // Pin mode for Output: Velocidad_Izquierda
    pinMode(5 , OUTPUT);
